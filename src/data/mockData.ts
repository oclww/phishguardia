...
export const pricingPlans: PricingPlan[] = [
  {
    ...
    monthlyPrice: 49,
    annualPrice: 39,
    description: 'Pour les équipes qui veulent démarrer simplement.',
    features: [
      '10 000 emails analysés/mois',
      'API REST complète',
      'Score de risque IA (Gemini 2.0)',
  ...
  },
  {
    ...
    monthlyPrice: 149,
    annualPrice: 119,
    description: 'Pour les équipes avec des volumes importants.',
    features: [
      '100 000 emails analysés/mois',
      'Tout le plan Starter inclus',
      'Webhooks temps réel',
      'Rapports mensuels automatiques',
      'Export CSV des données',
      'Historique 1 an',
      '6 gateways supportés',
      'Gestion d\'équipe',
      'Support prioritaire',
      'Accès aux beta features',
    ],
    notIncluded: [
      'Volume personnalisé',
      'Onboarding dédié',
  ...
  },
  {
    ...
    monthlyPrice: null,
    annualPrice: null,
    description: 'Pour les organisations avec des besoins spécifiques.',
    features: [
      'Volume personnalisé',
      'Tout le plan Pro inclus',
      'Onboarding technique dédié',
      'Contrat et SLA sur mesure',
